...
export interface MultiSendContractV100Interface extends utils.Interface {
    contractName: "MultiSendContractV100";
    functions: {
...
export interface MultiSendContractV100 extends BaseContract {
    contractName: "MultiSendContractV100";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MultiSendContractV100Interface;
