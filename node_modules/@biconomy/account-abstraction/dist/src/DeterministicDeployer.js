...
class DeterministicDeployer {
    ...
    constructor(provider = hardhat_1.ethers.provider) {
    ...
    async getDeployTransaction(ctrCode, salt = 0) {
        ...
        return {
            ...
            data: (0, utils_1.hexConcat)([saltEncoded, ctrCode])
        };
    }
    async getDeterministicDeployAddress(ctrCode, salt = 0) {
        ...
        const saltEncoded = (0, utils_1.hexZeroPad)((0, utils_1.hexlify)(salt), 32);
        return ('0x' +
            (0, utils_1.keccak256)((0, utils_1.hexConcat)(['0xff', this.proxyAddress, saltEncoded, (0, utils_1.keccak256)(ctrCode)])).slice(-40));
    }
    async deterministicDeploy(ctrCode, salt = 0) {
        ...
        if (!(await this.isContractDeployed(addr))) {
            await this.provider
                .getSigner()
                .sendTransaction(await this.getDeployTransaction(ctrCode, salt));
        }
        return addr;
    }
}
