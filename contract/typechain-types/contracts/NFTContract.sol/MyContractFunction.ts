...
export interface MyContractFunctionInterface extends utils.Interface {
  functions: {
    "approve(address,uint256)": FunctionFragment;
    "balanceOf(address)": FunctionFragment;
    "generateSVG(uint256)": FunctionFragment;
    "getApproved(uint256)": FunctionFragment;
    "getNFTID(uint256)": FunctionFragment;
...
export interface MyContractFunction extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: MyContractFunctionInterface;
