...
export interface DefaultCallbackHandlerV100Interface extends utils.Interface {
    contractName: "DefaultCallbackHandlerV100";
    functions: {
...
export interface DefaultCallbackHandlerV100 extends BaseContract {
    contractName: "DefaultCallbackHandlerV100";
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: DefaultCallbackHandlerV100Interface;
