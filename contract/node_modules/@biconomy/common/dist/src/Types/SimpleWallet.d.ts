...
export interface SimpleWalletInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "exec", values: [string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "execBatch", values: [string[], BytesLike[]]): string;
    encodeFunctionData(functionFragment: "execFromEntryPoint", values: [string, BigNumberish, BytesLike]): string;
    encodeFunctionData(functionFragment: "getDeposit", values?: undefined): string;
    encodeFunctionData(functionFragment: "nonce", values?: undefined): string;
    encodeFunctionData(functionFragment: "owner", values?: undefined): string;
    encodeFunctionData(functionFragment: "transfer", values: [string, BigNumberish]): string;
    encodeFunctionData(functionFragment: "updateEntryPoint", values: [string]): string;
...
export interface SimpleWallet extends BaseContract {
    ...
    functions: {
        ...
        exec(dest: string, value: BigNumberish, func: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        execBatch(dest: string[], func: BytesLike[], overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        execFromEntryPoint(dest: string, value: BigNumberish, func: BytesLike, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        ...
        updateEntryPoint(newEntryPoint: string, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
        validateUserOp(userOp: UserOperationStruct, requestId: BytesLike, aggregator: string, missingWalletFunds: BigNumberish, overrides?: Overrides & {
            from?: string | Promise<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        entryPoint(overrides?: CallOverrides): Promise<string>;
        exec(dest: string, value: BigNumberish, func: BytesLike, overrides?: CallOverrides): Promise<void>;
        execBatch(dest: string[], func: BytesLike[], overrides?: CallOverrides): Promise<void>;
        execFromEntryPoint(dest: string, value: BigNumberish, func: BytesLike, overrides?: CallOverrides): Promise<void>;
        getDeposit(overrides?: CallOverrides): Promise<BigNumber>;
        nonce(overrides?: CallOverrides): Promise<BigNumber>;
        owner(overrides?: CallOverrides): Promise<string>;
        transfer(dest: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
        updateEntryPoint(newEntryPoint: string, overrides?: CallOverrides): Promise<void>;
        validateUserOp(userOp: UserOperationStruct, requestId: BytesLike, aggregator: string, missingWalletFunds: BigNumberish, overrides?: CallOverrides): Promise<void>;
        withdrawDepositTo(withdrawAddress: string, amount: BigNumberish, overrides?: CallOverrides): Promise<void>;
    };
    filters: {
        "EntryPointChanged(address,address)"(oldEntryPoint?: string | null, newEntryPoint?: string | null): EntryPointChangedEventFilter;
        EntryPointChanged(oldEntryPoint?: string | null, newEntryPoint?: string | null): EntryPointChangedEventFilter;
    };
    estimateGas: {
        addDeposit(overrides?: PayableOverrides & {
            from?: string | Promise<string>;
