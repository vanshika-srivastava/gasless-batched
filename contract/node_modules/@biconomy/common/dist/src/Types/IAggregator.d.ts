...
export interface IAggregator extends BaseContract {
    ...
    estimateGas: {
        ...
        validateSignatures(userOps: UserOperationStruct[], signature: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        validateSignatures(userOps: UserOperationStruct[], signature: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
