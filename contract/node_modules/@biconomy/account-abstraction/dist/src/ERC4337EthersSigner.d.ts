...
export declare class ERC4337EthersSigner extends Signer {
    ...
    address?: string;
    sendTransaction(transaction: TransactionRequest, walletDeployOnly?: boolean, engine?: any): Promise<TransactionResponse>;
    sendTransactionBatch(transactions: TransactionRequest[], engine?: any): Promise<TransactionResponse>;
    ...
    signUserOperation(userOperation: UserOperation): Promise<string>;
}
