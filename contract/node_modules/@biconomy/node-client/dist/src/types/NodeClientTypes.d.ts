import { ChainId, SmartAccountVersion, MetaTransactionData, IFeeRefundV1_0_0, IFeeRefundV1_0_1 } from '@biconomy/core-types';
...
export type ChainConfig = {
    ...
    wallet: ContractDetails[];
    entryPoint: ContractDetails[];
    fallBackHandler: ContractDetails[];
